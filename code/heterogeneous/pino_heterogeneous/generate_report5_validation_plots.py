...
REPORT5_EXPERIMENTS: list[tuple[str, str, list[str]]] = [
    ...
    (
        "exp_Qa_piecewise_K100_N500_z1to5_min10pct_w64_float64_lr01_maxiter5",
        "piecewise",
        [
            "--design",
            "grf",
            ...
            "1000",
            "--out-dir",
            "results/exp_Qa_piecewise_K100_N500_z1to5_min10pct_w64_float64_lr01_maxiter5",
        ],
    ),
    (
        "exp_Qb_amort_piecewise_K100_N500_z1to5_min10pct_w64_float64_lr01_maxiter5",
        "piecewise",
        [
            "--design",
            "grf",
            ...
            "--amortize-branch",
            "--out-dir",
            "results/exp_Qb_amort_piecewise_K100_N500_z1to5_min10pct_w64_float64_lr01_maxiter5",
        ],
    ),
    (
        "exp_Qc_hard_tau005_piecewise_K100_N500_z1to5_min10pct_w64_float64_lr01_maxiter5",
        "piecewise",
        [
            "--design",
            "grf",
            ...
            "0.05",
            "--out-dir",
            "results/exp_Qc_hard_tau005_piecewise_K100_N500_z1to5_min10pct_w64_float64_lr01_maxiter5",
        ],
    ),
    (
        "exp_Qd_amort_hard_tau001_piecewise_K100_N500_z1to5_min10pct_w64_float64_lr01_maxiter5",
        "piecewise",
        [
            "--design",
            "grf",
            ...
            "0.01",
            "--out-dir",
            "results/exp_Qd_amort_hard_tau001_piecewise_K100_N500_z1to5_min10pct_w64_float64_lr01_maxiter5",
        ],
    ),
]
