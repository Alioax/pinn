...
training_params = {
    ...
    'collocation_points_t_star': 50,  # Number of uniformly-spaced points in t* direction
...
def train_pinn(model, training_params=None, plot_callback=None):
    ...
    for epoch in range(num_epochs):
        ...
        if plot_callback is not None and export_interval is not None and (epoch + 1) % export_interval == 0:
            ...
            plot_callback(model, epoch + 1, current_losses)
...
if __name__ == "__main__":
    ...
    def plot_epoch_callback(model, epoch_num, current_losses):
